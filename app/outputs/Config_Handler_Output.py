...
class Config_Handler:
	...
	def Import_Config(cls):
		...
		cls.lsb_Category3_Switches = cls.Clean_Convert_List_Boolean(
			obj_Proj_Config['Category3']['lsb_Category3_Switches'])
		cls.lstr_Category3_Generic_Text_List = cls.Clean_Convert_List_String(
			obj_Proj_Config['Category3']['lstr_Category3_Generic_Text_List'])
		cls.lsf_Category3_Generic_Float_Array = cls.Clean_Convert_List_Float(
			obj_Proj_Config['Category3']['lsf_Category3_Generic_Float_Array'])
		cls.lsi_Category3_Generic_Array = cls.Clean_Convert_List_Int(
			obj_Proj_Config['Category3']['lsi_Category3_Generic_Array'])
		cls.str_Category3_Generic_Text = str(obj_Proj_Config['Category3']['str_Category3_Generic_Text'])
		cls.f_Category3_Generic_Float_Number = cls.Clean_Convert_Float(
			obj_Proj_Config['Category3']['f_Category3_Generic_Float_Number'])
		cls.i_Category3_Generic_Number = cls.Clean_Convert_Int(
			obj_Proj_Config['Category3']['i_Category3_Generic_Number'])
		cls.lsb_Category2_Switches = cls.Clean_Convert_Boolean(obj_Proj_Config['Category2']['lsb_Category2_Switches'])
		cls.lsb_Category2_Switches = cls.Clean_Convert_List_Boolean(
			obj_Proj_Config['Category2']['lsb_Category2_Switches'])
		cls.lsf_Category2_Generic_Float_Array_New_Line = cls.Clean_Convert_List_Float(
			obj_Proj_Config['Category2']['lsf_Category2_Generic_Float_Array_New_Line'])
		cls.lsi_Category2_Generic_Array_New_Line = cls.Clean_Convert_List_Int(
			obj_Proj_Config['Category2']['lsi_Category2_Generic_Array_New_Line'])
		cls.str_Category2_Generic_Text_New_Line = str(
			obj_Proj_Config['Category2']['str_Category2_Generic_Text_New_Line'])
		cls.llstr_Category1_Generic_Text_List_Of_Lists = cls.Clean_Convert_List_String(
			obj_Proj_Config['Category1']['llstr_Category1_Generic_Text_List_Of_Lists'])
		cls.lstr_Category1_Generic_Text_List = cls.Clean_Convert_List_String(
			obj_Proj_Config['Category1']['lstr_Category1_Generic_Text_List'])
		cls.lsf_Category1_Generic_Float_Array = cls.Clean_Convert_List_Float(
			obj_Proj_Config['Category1']['lsf_Category1_Generic_Float_Array'])
		cls.lsi_Category1_Generic_Array = cls.Clean_Convert_List_Int(
			obj_Proj_Config['Category1']['lsi_Category1_Generic_Array'])
		cls.str_Category1_Generic_Text = str(obj_Proj_Config['Category1']['str_Category1_Generic_Text'])
		cls.f_Category1_Generic_Float_Number = cls.Clean_Convert_Float(
			obj_Proj_Config['Category1']['f_Category1_Generic_Float_Number'])
		cls.i_Category1_Generic_Number = cls.Clean_Convert_Int(
			obj_Proj_Config['Category1']['i_Category1_Generic_Number'])
		cls.lsb_Category1_Switches = cls.Clean_Convert_Boolean(obj_Proj_Config['Category1']['lsb_Category1_Switches'])
		cls.lsb_Category1_Switches = cls.Clean_Convert_List_Boolean(
			obj_Proj_Config['Category1']['lsb_Category1_Switches'])
